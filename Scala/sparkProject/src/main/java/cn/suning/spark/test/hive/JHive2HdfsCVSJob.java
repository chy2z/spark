 ...
 * @description:
 * @author: 18093941
 * @create: 2019-03-09 09:58
 **/
public class JHive2HdfsCVSJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD mainRdd = rowRdd.mapPartitionsToPair(new PairFlatMapFunction<Iterator<Row>, String, String>() {
            public Iterator<Tuple2<String, String>> call(Iterator<Row> rowIterator) throws Exception {
                ...
                while (rowIterator.hasNext()) {
                    ...
                    resultList.add(row.getString(0));
                    resultList.add(row.getInt(1));
                    resultList.add(row.getString(2));
                    resultList.add(row.getString(3));

                    Tuple2 t2 = new Tuple2(row.getString(0), StringUtils.join(resultList, "\t"));
                    list.add(t2);
                }
         ...
         * 按照不同的key生成key.csv文件
         */
        mainRdd.partitionBy(new HashPartitioner(2)).saveAsHadoopFile(outputPath, String.class, String.class, RDDMultipleTextOutputFormatCVS.class);
    ...
    protected static class RDDMultipleTextOutputFormatCVS extends MultipleOnlyValueOutputFormat<String, String> {
    ...
    protected static class MultipleOnlyValueOutputFormat<K, V> extends MultipleOutputFormat<K, V> {
        private OnlyValueOutputFormat<K, V> theTextOutputFormat = null;
        ...
        protected RecordWriter<K, V> getBaseRecordWriter(FileSystem fs, JobConf job, String name, Progressable arg3)
            ...
            if (this.theTextOutputFormat == null) {
                this.theTextOutputFormat = new OnlyValueOutputFormat();
            }
