...
public class JHbaseJob2 {
    ...
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = initSparkConf(JHbaseJob2.class.getName(), args, 4);
        ...
        cfg.addResource(JHbaseJob2.class.getClassLoader().getResourceAsStream("hbase-site-dev.xml"));
